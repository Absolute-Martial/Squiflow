...
internal static class TenancyModel
{
    internal static void Build(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity("SquiFlow.Tenancy.Postgres.TenantRow", entity =>
        {
        ...
        modelBuilder.Entity("SquiFlow.Tenancy.Postgres.TenantMembershipRow", entity =>
        {
        ...
        modelBuilder.Entity("SquiFlow.Tenancy.Postgres.TenantMembershipRow", entity =>
        {
            entity.HasOne("SquiFlow.Tenancy.Postgres.TenantRow", null)
                .WithMany()
