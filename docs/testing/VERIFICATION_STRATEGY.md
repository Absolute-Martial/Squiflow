...
| StyleCop, NetArchTest | Not selected: current SDK analyzers, format check and the project-graph architecture suite cover the present rules. Reconsider when a specific unenforced rule appears. |
